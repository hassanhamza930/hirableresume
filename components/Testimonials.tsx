  ...
  return (
    <div className="w-full flex flex-col justify-start items-center px-[5%] sm:px-[10%] mt-24 md:mt-48">
      ...
      <BlurReveal
        ...
        className="mb-2 text-2xl sm:text-3xl md:text-4xl text-center flex flex-wrap gap-x-2 justify-center items-center text-shadow-2xs text-shadow-blue-600 px-4"
...
function TestimonialCard({ testimonial }: { testimonial: typeof testimonials[0] }) {
  return (
    <Card className="w-[280px] sm:w-[320px] md:w-[350px] bg-white/5 backdrop-blur-xl border border-white/10 shadow-xl shadow-white/5 hover:shadow-white/10 transition-all duration-300">
      ...
      <CardContent>
        <p style={{ fontFamily: "Geist" }} className="text-white/80 text-xs md:text-sm">
          "{testimonial.content}"
        </p>
      </CardContent>
    </Card>
